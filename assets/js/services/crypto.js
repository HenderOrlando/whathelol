...
// rCon is Round Constant used for the Key Expansion [1st col is 2^(r-1) in GF(2^8)] [§5.2]
    ...
    /* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -  */
    /*if (typeof module!='undefined' && module.exports){
     var Aes = require('./aes'); // CommonJS (Node.js)
     } */
    ...
    if (typeof String.prototype.utf8Encode == 'undefined') {
        String.prototype.utf8Encode = function () {
            return Base64._utf8_encode(encodeURIComponent(this));
    ...
    if (typeof String.prototype.utf8Decode == 'undefined') {
        String.prototype.utf8Decode = function () {
            try {
                ...
                return decodeURIComponent(Base64._utf8_decode(this));
            } catch (e) {
    ...
    /** Extend String object with method to capitalize */
    ...
    /**
     * @ngdoc service
     * @name justsapiensApp.crypto
     * @description
     * # crypto
     * Service in the justsapiensApp.
     */
    ...
    function crypto() {
        ...
        function encode(str, isJson, key) {
            var enc = null;
            ...
            if (key) {
                ...
                for(var i = 0; i < key.length; i++){
                    enc = Aes.Ctr.encrypt(enc, key, 256);
                }
            } else {
                enc = str.base64Encode();
            }
            return enc;
        }

        function decode(str, isJson, key) {
            var dec = '';
            if (key) {
                dec = Aes.Ctr.encrypt(str, key, 256);
            } else {
                dec = str.base64Decode(str);
            }
            if (isJson) {
                try {
                    dec = JSON.parse(dec);
