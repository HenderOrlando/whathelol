...
(function(){
    ...
    /**
     * @ngdoc function
     * @name SolucionesCucutaApp.directive:pempoDatetimeCalendar
     * @description
     * # pempoDatetimeCalendar
     * PempoDatetimeCalendar
     */
    angular.module('SolucionesCucutaApp')
        .directive('pempoDatetimeCalendar', [
            'templateCache',
            pempoDatetimeCalendarDirective
        ])
    ;

    function pempoDatetimeCalendarDirective (templateCache) {
        ...
        return {
            ...
            template: templateCache.getHtml('pempodatetimecalendar')
        };
    }
})();
